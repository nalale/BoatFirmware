...
// Статические параметры неисправности
dtcProperty_t dtcProp_UnexpectedPowerOff = { dtc_General_UnexpectedPowerOff, DTC_BIT_WARNING_ENABLE, 0, 1, -1, 10, DIAG_ITEM(dVal_frzfUnexpectedPowerOff) };
// Все о неисправности
...
// Статические параметры неисправности
dtcProperty_t dtcProp_Interlock = { dtc_General_Interlock, DTC_BIT_NONE + DTC_BIT_AUTO_RESTORE, 0, 10, -10, 10, DIAG_ITEM(dVal_frzfInterlock) };
// Все о неисправности
...
// Статические параметры неисправности
dtcProperty_t dtcProp_PMOffline = { dtc_CAN_PM, DTC_BIT_WARNING_ENABLE + DTC_BIT_AUTO_RESTORE, 0, 4, -1, 500, DIAG_ITEM(dVal_frzfPMOffline) };
// Все о неисправности
...
// Статические параметры неисправности
dtcProperty_t dtcProp_VcuOffline = { dtc_CAN_mainVcu, DTC_BIT_WARNING_ENABLE + DTC_BIT_OPERATION_DISABLE, 0, 4, -1, 500, DIAG_ITEM(dVal_frzfVcuOffline) };
// Все о неисправности
...
// Статические параметры неисправности
dtcProperty_t dtcProp_Contactor = { dtc_Mod_Contactor, DTC_BIT_WARNING_ENABLE + DTC_BIT_OPERATION_DISABLE, 0, 15, -15, 10, DIAG_ITEM(dVal_frzfContactor) };
// Все о неисправности
...
// Статические параметры неисправности
dtcProperty_t dtcProp_CellTemperature = { dtc_Mod_CellTempOutOfRange, DTC_BIT_WARNING_ENABLE + DTC_BIT_AUTO_RESTORE, 0, 10, -10, 250, DIAG_ITEM(dVal_frzfCellTemperature) };
// Все о неисправности
...
// Статические параметры неисправности
dtcProperty_t dtcProp_MeasuringCircuit = { dtc_Mod_MeasuringCircuit, DTC_BIT_WARNING_ENABLE + DTC_BIT_OPERATION_DISABLE, 0, 1, -1, 10, DIAG_ITEM(dVal_frzfMeasuringCircuit) };
// Все о неисправности
...
// Статические параметры неисправности
dtcProperty_t dtcProp_ModuleState = { dtc_Bat_WrongModState, DTC_BIT_WARNING_ENABLE + DTC_BIT_OPERATION_DISABLE, 0, 2, -2, 250, DIAG_ITEM(dVal_frzfModuleState) };
// Все о неисправности
...
// Статические параметры неисправности
dtcProperty_t dtcProp_OverCurrent = { dtc_Bat_OverCurrent, DTC_BIT_WARNING_ENABLE + DTC_BIT_AUTO_RESTORE, 0, 10, -10, 250, DIAG_ITEM(dVal_frzfOverCurrent) };
// Все о неисправности
...
// Статические параметры неисправности
dtcProperty_t dtcProp_ModVoltageDiff = { dtc_Bat_ModVoltageDiff, DTC_BIT_WARNING_ENABLE + DTC_BIT_AUTO_RESTORE, 0, 10, -10, 250, DIAG_ITEM(dVal_frzfModVoltageDiff) };
// Все о неисправности
...
// Статические параметры неисправности
static dtcProperty_t dtcProp_BatNumber = { dtc_Mst_WrongBatNumber, DTC_BIT_WARNING_ENABLE + DTC_BIT_OPERATION_DISABLE, 0, 4, -4, 250, DIAG_ITEM(dVal_frzfBatNumber) };
// Все о неисправности
...
// Статические параметры неисправности
static dtcProperty_t dtcProp_BatVoltageDiff = { dtc_Mst_BatVoltageDiff, DTC_BIT_WARNING_ENABLE + DTC_BIT_OPERATION_DISABLE, 0, 5, -5, 250, DIAG_ITEM(dVal_frzfBatVoltageDiff) };
// Все о неисправности
...
void ecuInit(ObjectDictionary_t *dictionary)
{
	...
	//dictionary->SData.dtcListData = dtcList;
