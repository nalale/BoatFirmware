...
uint8_t SteeringInit(SteeringData_t *_steeringData, PID_Struct_t *PID, const uint8_t *FeedbackVoltage_0p1V, uint8_t MinPosLimit_V, uint8_t MaxPosLimit_V, const uint16_t *fstDriverCurrent, const uint16_t *sndDriverCurrent, uint16_t CurrentLimit);
